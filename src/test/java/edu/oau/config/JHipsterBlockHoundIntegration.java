...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("edu.oau.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("edu.oau.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
